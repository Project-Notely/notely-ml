...
from app.models.segmentation_models import SegmentationResult, DocumentSegment
        ...
        for i, result_data in enumerate(results, 1):
            ...
            if result['success']:
                ...
                if result.get('image_info'):
                    ...
                    print(f"   Image: {img_info['width']}x{img_info['height']} {img_info['format']}")
                ...
                if result['segments']:
                    ...
                    type_summary = ", ".join([f"{k}: {v}" for k, v in segment_types.items()])
