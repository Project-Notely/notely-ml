...
from app.models.segmentation_models import SegmentationResult, DocumentSegment, SegmentType
...
class TestSegmentationServicePerformance:
    ...
    @pytest.mark.asyncio
    async def test_single_document_processing_time(self, segmentation_service, sample_text_file):
    ...
    @pytest.mark.performance
    @pytest.mark.asyncio
    async def test_multiple_documents_sequential(self, segmentation_service, sample_text_file):
    ...
    @pytest.mark.performance
    @pytest.mark.asyncio
    async def test_multiple_documents_concurrent(self, segmentation_service, sample_text_file):
        ...
        with patch('app.services.segmentation_service.partition') as mock_partition:
            ...
            assert total_time < 7.0  # Should be significantly faster than 10s sequential
    ...
    @pytest.mark.performance
    def test_memory_usage_multiple_documents(self, segmentation_service, sample_text_file):
    ...
    @pytest.mark.performance
    @pytest.mark.asyncio
    async def test_cpu_usage_during_processing(self, segmentation_service, sample_text_file):
    ...
    @pytest.mark.performance
    @pytest.mark.asyncio
    async def test_throughput_documents_per_second(self, segmentation_service, sample_text_file):
        ...
        with patch('app.services.segmentation_service.partition') as mock_partition:
            ...
            assert throughput > 5.0  # At least 5 documents per second for mocked service
    ...
    @pytest.mark.performance
    @pytest.mark.asyncio
    async def test_concurrent_load_handling(self, segmentation_service, sample_text_file):
        ...
        with patch('app.services.segmentation_service.partition') as mock_partition:
            ...
            successful_results = [r for r in results if isinstance(r, SegmentationResult) and r.success]
            failed_results = [r for r in results if not (isinstance(r, SegmentationResult) and r.success)]
...
class TestSegmentationServiceStress:
    ...
    @pytest.mark.stress
    @pytest.mark.asyncio
    async def test_long_running_processing(self, segmentation_service, sample_text_file):
        ...
        with patch('app.services.segmentation_service.partition') as mock_partition:
            ...
            assert processed_count > 100  # Should process at least 100 documents in 1 minute
    ...
    async def test_memory_pressure_handling(self, segmentation_service):
        ...
        with patch('app.services.segmentation_service.partition') as mock_partition:
            ...
            for i in range(20):
                ...
                large_image = Image.new('RGB', (size, size), color=f'rgb({i*10}, {i*10}, {i*10})')
    ...
    @pytest.mark.stress
    @pytest.mark.asyncio 
    async def test_rapid_successive_requests(self, segmentation_service, sample_text_file):
        ...
        with patch('app.services.segmentation_service.partition') as mock_partition:
            ...
            # Count successful results
            successful = [r for r in results if isinstance(r, SegmentationResult) and r.success]
...
class TestSegmentationServiceResourceLimits:
    ...
    @pytest.mark.limit
    @pytest.mark.asyncio
    async def test_maximum_concurrent_connections(self, segmentation_service, sample_text_file):
