...
def main():
    ...
    commands = {
        "models": {
            "cmd": ["python3", "-m", "pytest", "tests/repositories/drawing_repository.py::TestDrawingModels", "-v"],
            "desc": "Running Drawing Models Tests"
        },
        "repository": {
            "cmd": ["python3", "-m", "pytest", "tests/repositories/drawing_repository.py::TestDrawingRepository", "-v"],
            "desc": "Running Drawing Repository Tests"
        },
        "all": {
            "cmd": ["python3", "-m", "pytest", "tests/repositories/drawing_repository.py", "-v"],
            "desc": "Running All Drawing Tests"
        },
        "coverage": {
            "cmd": ["python3", "-m", "pytest", "tests/repositories/drawing_repository.py", "-v", "--cov=app", "--cov-report=term-missing"],
